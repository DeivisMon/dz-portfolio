...
export default function ContactSocials() {
  ...
  return (
    <Motion.div
      ...
      initial="hidden"
      animate="show"
      className="social-icons flex flex-col justify-center space-y-0 xl:space-y-4"
    >
      {/* Socials with underline hover */}
      <div className="flex flex-col items-start py-2 md:border-b border-white/40">
        <h2 className="text-md lg:text-4xl font-thin tracking-[clamp(0.5em,calc(0.05em+0.3vw),0.25em)] lg:pb-12 text-header">
          Susisiekime
        </h2>
        <h2 className="text-md lg:text-xl tracking-[clamp(0.5em,calc(0.05em+0.3vw),0.25em)] font-thin text-header">
          Socialinai
        </h2>
            ...
            >
              <div className="flex items-center justify-between py-2">
                <Motion.div
                  ...
                  className="text-sm lg:text-lg tracking-[0.25em] relative"
                  aria-label={label}
                >
                  <AnimatedText
                    text={label}
                ...
                {!responsive.isMobile && (
                  <span className="opacity-0 -rotate-180 text-muted translate-y-2 group-hover:translate-y-0 group-hover:opacity-100 group-hover:rotate-0 bg-gray-600/10 rounded-full transition-all duration-300 ease-in-out ">
                    <MdArrowOutward
      ...
      <div className="flex flex-col items-start justify-center py-2 md:border-b border-white/40">
        ...
        <div className="relative">
          <div
            ...
            className="cursor-trigger cursor-pointer relative text-gray-500 text-sm lg:text-lg tracking-[clamp(0.15em,0.6vw,0.4em)] py-2"
          >
            <AnimatedText
            ...
            {responsive.isMobile || responsive.isTablet ? null : isHoveringEmail && !copied ? (
              <span className="absolute -translate-x-1/2 -right-15 -top-3 rounded bg-gray-600/25 px-2 py-1 text-xs text-muted whitespace-nowrap tracking-[1px]">
                Kopijuok
              </span>
            ) : (
              copied && (
